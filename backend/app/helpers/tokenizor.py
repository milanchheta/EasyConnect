'''
This file was used to genereate keywords and 
compute cosine similarity based on keywords
'''
...
'''
Funtion to pre process the text
'''
def deep_clean(text):
    text = str(text).lower() 
...
'''
Function to generate keywords for given text
'''
...
'''
Function to compute cosine similarity based on keywords
'''
